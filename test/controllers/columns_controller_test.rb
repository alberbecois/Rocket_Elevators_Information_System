...
class ColumnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post columns_url, params: { column: { battery_id: @column.battery_id, column_status: @column.column_status, column_type: @column.column_type, floors: @column.floors, information: @column.information, notes: @column.notes } }
    end
  ...
  test "should update column" do
    patch column_url(@column), params: { column: { battery_id: @column.battery_id, column_status: @column.column_status, column_type: @column.column_type, floors: @column.floors, information: @column.information, notes: @column.notes } }
